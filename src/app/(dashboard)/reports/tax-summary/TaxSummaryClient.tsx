    ...
    <div className="flex flex-col h-full bg-slate-950 text-white overflow-y-auto">
      ...
      <div className="p-6 md:p-8 max-w-4xl mx-auto w-full space-y-8 print:p-0 print:text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 print:hidden">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-slate-900/40 border border-white/10 rounded-2xl p-6 relative overflow-hidden">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-slate-900/40 border border-white/10 rounded-2xl p-6 relative overflow-hidden">
