...
const EMPLOYEES: Employee[] = [
  { id: "ceo", name: "Sarah Connor", role: "CEO", department: "Executive", productivity: 0.95, pos: [0, 4, 0], parentId: null },
  { id: "cto", name: "John Smith", role: "CTO", department: "Engineering", productivity: 0.88, pos: [-4, 1, 0], parentId: "ceo" },
  { id: "cmo", name: "Emily Chen", role: "CMO", department: "Marketing", productivity: 0.92, pos: [4, 1, 0], parentId: "ceo" },
  { id: "dev1", name: "Alice Wang", role: "Senior Dev", department: "Engineering", productivity: 0.98, pos: [-6, -2, 2], parentId: "cto" },
  { id: "dev2", name: "Bob Martin", role: "Backend Dev", department: "Engineering", productivity: 0.75, pos: [-4, -2, -2], parentId: "cto" },
  { id: "dev3", name: "Charlie Day", role: "Frontend Dev", department: "Engineering", productivity: 0.85, pos: [-2, -2, 2], parentId: "cto" },
  { id: "mkt1", name: "Diana Prince", role: "Growth Lead", department: "Marketing", productivity: 0.91, pos: [2, -2, 2], parentId: "cmo" },
  { id: "mkt2", name: "Evan Wright", role: "Content", department: "Marketing", productivity: 0.82, pos: [6, -2, -2], parentId: "cmo" },
];
...
function EmployeeNode({ data, isSelected, onClick }: { data: Employee, isSelected: boolean, onClick: (data: Employee) => void }) {
  ...
  return (
    <Float speed={2} rotationIntensity={0.5} floatIntensity={0.5}>
      <group position={new THREE.Vector3(...data.pos)}>
        <mesh 
          ref={meshRef} 
          scale={scale}
    ...
    <div className="w-full h-full flex flex-col bg-slate-950 overflow-hidden relative">
      ...
      <div className="absolute inset-0 z-0">
        <Canvas camera={{ position: [0, 2, 15], fov: 45 }}>
          ...
          <OrgConnections nodes={EMPLOYEES} />
