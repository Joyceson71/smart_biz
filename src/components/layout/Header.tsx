          ...
          <div className="mr-8 flex items-center">
            <Link href="/dashboard" className="flex items-center space-x-3 group">
              <div className="w-8 h-8 rounded-xl neo-flat flex items-center justify-center transition-transform group-hover:scale-105">
                <span className="text-sm font-bold text-blue-500">SB</span>
              </div>
              <span className="hidden font-bold sm:inline-block text-slate-700 text-lg">
                SmartBiz
              </span>
            </Link>
          </div>
            ...
            <nav className="flex items-center space-x-3">
              <div className="relative hidden xl:flex w-full max-w-sm items-center space-x-2 mr-2">
                ...
                <input
                  type="search"
                  placeholder="Search..."
                  className="h-10 w-[250px] pl-10 pr-4 neo-pressed rounded-xl border-none outline-none text-sm text-slate-600 placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500/20 transition-all bg-transparent"
                />
              </div>
              
              <button className="h-10 w-10 flex items-center justify-center neo-flat rounded-xl text-slate-500 hover:text-blue-500 transition-colors active:neo-pressed">
                <Bell className="h-5 w-5" />
                <span className="sr-only">Notifications</span>
              </button>
              
              <Link href="/settings" className="h-10 w-10 flex items-center justify-center neo-flat rounded-xl text-slate-500 hover:text-blue-500 transition-colors active:neo-pressed">
                <Settings className="h-5 w-5" />
                <span className="sr-only">Settings</span>
              </Link>
              
              <div className="h-10 w-10 rounded-xl neo-flat flex items-center justify-center text-sm font-bold text-slate-600 cursor-pointer ml-2 hover:text-blue-600 transition-colors active:neo-pressed">
                JD
              </div>
            </nav>
          </div>
